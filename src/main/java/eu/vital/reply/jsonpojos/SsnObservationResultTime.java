...
public class SsnObservationResultTime {
    ...
    public<T >T get(String name) {
        Object value = declaredPropertyOrNotFound(name, SsnObservationResultTime.NOT_FOUND_VALUE);
        if (SsnObservationResultTime.NOT_FOUND_VALUE!= value) {
            return ((T) value);
        } else {
    ...
    public SsnObservationResultTime with(String name, Object value) {
        if (!declaredProperty(name, value)) {
            getAdditionalProperties().put(name, ((Object) value));
        }
        return this;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SsnObservationResultTime) == false) {
            return false;
        }
        SsnObservationResultTime rhs = ((SsnObservationResultTime) other);
