...
public class DulHasLocation {
    ...
    public<T >T get(String name) {
        Object value = declaredPropertyOrNotFound(name, DulHasLocation.NOT_FOUND_VALUE);
        if (DulHasLocation.NOT_FOUND_VALUE!= value) {
            return ((T) value);
        } else {
    ...
    public DulHasLocation with(String name, Object value) {
        if (!declaredProperty(name, value)) {
            getAdditionalProperties().put(name, ((Object) value));
        }
        return this;
