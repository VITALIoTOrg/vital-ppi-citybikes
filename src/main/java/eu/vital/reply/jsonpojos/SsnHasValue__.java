...
public class SsnHasValue__ {
    ...
    public<T >T get(String name) {
        Object value = declaredPropertyOrNotFound(name, SsnHasValue__.NOT_FOUND_VALUE);
        if (SsnHasValue__.NOT_FOUND_VALUE!= value) {
            return ((T) value);
        } else {
    ...
    public SsnHasValue__ with(String name, Object value) {
        if (!declaredProperty(name, value)) {
            getAdditionalProperties().put(name, ((Object) value));
        }
        return this;
