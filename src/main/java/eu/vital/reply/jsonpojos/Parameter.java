...
public class Parameter {
        ...
        switch (name) {
            ...
            case "permissions":
                if (value instanceof String) {
                    ...
                    throw new IllegalArgumentException(("property \"permissions\" is of type \"java.lang.String\", but got "+ value.getClass().toString()));
                }
                return true;
            default:
                return false;
    ...
    public<T >T get(String name) {
        Object value = declaredPropertyOrNotFound(name, Parameter.NOT_FOUND_VALUE);
        if (Parameter.NOT_FOUND_VALUE!= value) {
            return ((T) value);
        } else {
    ...
    public Parameter with(String name, Object value) {
        if (!declaredProperty(name, value)) {
            getAdditionalProperties().put(name, ((Object) value));
        }
        return this;
