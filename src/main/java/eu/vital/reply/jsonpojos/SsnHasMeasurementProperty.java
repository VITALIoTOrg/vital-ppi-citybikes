...
public class SsnHasMeasurementProperty {
    ...
    public<T >T get(String name) {
        Object value = declaredPropertyOrNotFound(name, SsnHasMeasurementProperty.NOT_FOUND_VALUE);
        if (SsnHasMeasurementProperty.NOT_FOUND_VALUE!= value) {
            return ((T) value);
        } else {
    ...
    public SsnHasMeasurementProperty with(String name, Object value) {
        if (!declaredProperty(name, value)) {
            getAdditionalProperties().put(name, ((Object) value));
        }
        return this;
